...
CREATE TABLE `supplier_ingredients` (
  ...
  CONSTRAINT `supplier_ingredients_ibfk_1` FOREIGN KEY (`Supplier_id`) REFERENCES `supplier` (`Supplier_id`),
  CONSTRAINT `supplier_ingredients_ibfk_2` FOREIGN KEY (`Ingredient_id`) REFERENCES `ingredient` (`Ingredient_id`)
...
INSERT INTO `supplier_ingredients` VALUES (1,1),(1,2),(2,3),(3,4);
